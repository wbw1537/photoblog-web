...
const BlogGallery: React.FC<BlogGalleryProps> = ({ initialFilters, onBlogSelect }) => {
  ...
  const fetchBlogs = useCallback(async () => {
    ...
    try {
      ...
      // Use getBlogList with proper error handling
      const response = await blogApi.getBlogList(currentFilters);
